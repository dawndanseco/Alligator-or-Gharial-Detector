...
dir = '/content/drive/MyDrive/Colab Notebooks/DATA/Final Exam_DANSECO/Reptiles'
...
Gharial = '/content/drive/MyDrive/Colab Notebooks/DATA/Final Exam_DANSECO/Reptiles/gharial'
Alligator = '/content/drive/MyDrive/Colab Notebooks/DATA/Final Exam_DANSECO/Reptiles/alligator'


print("Number of Images per Class:\n")

print("Gharial: {}".format(len(os.listdir(Gharial))))
print("Alligator: {}".format(len(os.listdir(Alligator))))
...
X, y = make_train_dataset(Gharial, "Gharial")
X, y = make_train_dataset(Alligator, "Alligator")
...
filepath="/content/drive/MyDrive/Colab Notebooks/DATA/Final Exam_DANSECO/Model/weights-improvement-{epoch:02d}-{val_accuracy:.2f}.hdf5"
...
def run_test_harness():
	model = load_model('/content/drive/MyDrive/Colab Notebooks/DATA/Final Exam_DANSECO/Model/weights-improvement-09-0.90.hdf5')
...
# Load saved model
saved_model = load_model("/content/drive/MyDrive/Colab Notebooks/DATA/Final Exam_DANSECO/Model/weights-improvement-09-0.90.hdf5")

# Load sample image
image = cv2.imread("/content/drive/MyDrive/Colab Notebooks/DATA/Final Exam_DANSECO/Reptiles/alligator/Web-Thumbnail-Alligator-2-Z2Y.jpg")
...
class_labels = ["Alligator", "Gharial", ]
...
image1 = cv2.imread("/content/drive/MyDrive/Colab Notebooks/DATA/Final Exam_DANSECO/Reptiles/gharial/262a9f3371c381ead5790a4ba5379567--strange-animals-san-diego-zoo.jpg")
